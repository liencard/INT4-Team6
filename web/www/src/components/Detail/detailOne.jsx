            ...
            <div className={styles.timeframe__info}>
              <section>
                ...
                <p className={styles.text}>
                  ...
                  Revolution. Margaret was born into this revolution as a sewer.
                  At the start of the century it caused many problems but later
                  on the lifes of the people became more comfortable for the
                  ordinary.
                </p>
              </section>
              <section>
                ...
                <p className={styles.text}>
                  ...
                  came from Ireland, fleeing for a terrible potato famine. Some
                  Russian Jews, that were being persecuted, also fled to Britian
                  in London.
                </p>
              </section>
              <section>
                ...
                <p className={styles.text}>
                  ...
                  and was given to more men. However females weren’t allowed to
                  vote until the 1897.
                </p>
              </section>
            </div>
          ...
          <article className={`${styles.living} ${styles.content}`}>
            <div className={styles.living__text}>
              ...
              <p className={styles.text}>
                ...
                that it was cheaper. However this was in cost of the design. Due
                to this, middle class families had overcrowded homes with lots
                of furtniture, ornaments and knick-knacks.
              </p>
              <p className={styles.text}>
                They had a house with two rooms upstairs and two downstairs. The
                two rooms downstairs were used kitching and living room while
                thet wo upstairs were bedrooms.
              </p>
            </div>
            ...
            <div className={styles.work__text}>
              <section>
                ...
                <p className={styles.text}>
                  ...
                  laundresses or servant. While men and childeren usually worked
                  in the factories and did long shifts every day.
                </p>
              </section>
              <section>
                ...
                <p className={styles.text}>
                  ...
                  job. These types of clothing were called corsets and knickers.
                </p>
              </section>
            </div>
          </article>
