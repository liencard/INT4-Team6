    ...
    <>
      ...
      <article className={`${styles.container} ${styles.work}`}>
        ...
        <section>
          ...
          <p className={styles.text}>
            Back in the 1800’s a lot of women used to be charwomen, laundresses
            or servant. While men and childeren usually worked in the factories
            and did long shifts every day.
          </p>
        </section>
        <section>
          ...
          <p className={styles.text}>
            ...
            clothing. Shoes, for example, were a luxery and not a lot of people
            owned them. Being a sewer back in the day was a good job. These
            types of clothing were called corsets and knickers.
          </p>
        </section>
      </article>
      ...
      <article className={styles.container}>
        ...
        <section className={styles.death__start}>
          ...
          <p className={styles.text}>
            ...
            Margaret was born into this revolution as a sewer. At the start of
            the century it caused many problems but later on the lifes of the
            people became more comfortable for the ordinary.
          </p>
        </section>
      </article>
    </>
